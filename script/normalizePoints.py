...
def SaveNormalizedPoints(npArray_file_path, target_path):
    ...
    np.save(f'{target_path}/{base_filename}_normalized.npy', points)
    print(f'{target_path}/{base_filename}_normalized.npy saved')
...
SaveNormalizedBatch('FaceOn/data/landmarks/part1', 'FaceOn/data/normalized/part1')
SaveNormalizedBatch('FaceOn/data/landmarks/part2', 'FaceOn/data/normalized/part2')
SaveNormalizedBatch('FaceOn/data/landmarks/part3', 'FaceOn/data/normalized/part3')